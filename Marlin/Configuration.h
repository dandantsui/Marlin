...
#define STRING_CONFIG_H_AUTHOR "(Daniel Tsui)" // Who made the changes.
 ...
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT 3       // USB Serial Port for MKS_ROBIN
#define HAVE_SW_SERIAL 1
/**
 * Select a secondary serial port on the board to use for communication with the host.
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT_2 1     // WiFi Serial Port for MKS_ROBIN
#define NUM_SERIAL 2
...
#define CUSTOM_MACHINE_NAME "DK2"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 124.35
  #define DEFAULT_bedKi 14.63
  #define DEFAULT_bedKd 704.39
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 83.62 }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MAX_POS - 25), (Y_MAX_POS - 20), 20 }
